...
//        }
    ...
    // TODO ajouter les dates
        $query = "SELECT * FROM documents WHERE document_state='En cours'AND document_state='Termine' AND status_payments=1";
    ...
    //------- get Solde --------
            // TODO ajouter les dates
    $query = "SELECT * FROM documents WHERE document_state='En cours' AND document_state='Termine' AND status_payments=2";
